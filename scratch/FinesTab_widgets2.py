...
content = content.replace(
    'className={`flex-[0.8] w-full space-y-6`}',
...
# The user said: "tôi muốn xoá cái hình chữ nhật trắng to đùng kia được không tôi muốn dùng cái nền lưới cho đẹp"
# Currently the content wrapper is:
...
# I will change it to completely transparent!
